...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("TypeFactDS"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class TypeFactDS
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As TypeFactDS = CType(MyBase.Clone,TypeFactDS)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "TypeFactDS"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/TypeFactDS.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As TypeFactDS = New TypeFactDS()
...
Namespace TypeFactDSTableAdapters
    ...
    Partial Public Class TypeFactTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `TypeFact` WHERE (((? = 1 AND `TYPF_OMSCHRIJVING` IS NULL) OR (`TYPF_"& _ 
                "OMSCHRIJVING` = ?)) AND ((? = 1 AND `TYPF_Conversion` IS NULL) OR (`TYPF_Convers"& _ 
                "ion` = ?)) AND (`TYPF_ID` = ?) AND ((? = 1 AND `TypF_actief` IS NULL) OR (`TypF_"& _ 
                "actief` = ?)))"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `TypeFact` SET `TYPF_OMSCHRIJVING` = ?, `TYPF_Conversion` = ?, `TypF_actie"& _ 
                "f` = ? WHERE (((? = 1 AND `TYPF_OMSCHRIJVING` IS NULL) OR (`TYPF_OMSCHRIJVING` ="& _ 
                " ?)) AND ((? = 1 AND `TYPF_Conversion` IS NULL) OR (`TYPF_Conversion` = ?)) AND "& _ 
                "(`TYPF_ID` = ?) AND ((? = 1 AND `TypF_actief` IS NULL) OR (`TypF_actief` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     TYPF_OMSCHRIJVING, TYPF_Conversion, TYPF_ID, TypF_actief"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM        "& _ 
                " TypeFact"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (TYPF_ID = ?)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(0).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("TYPF_ID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "TYPF_ID", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT TYPF_Conversion, TYPF_ID, TYPF_OMSCHRIJVING, TypF_actief FROM TypeFact"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(2).Connection = Me.Connection
            Me._commandCollection(2).CommandText = "SELECT     TYPF_ID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         TypeFact"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (TYPF_OMSCHRIJVING = ?)"
            Me._commandCollection(2).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(2).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("TYPF_OMSCHRIJVING", Global.System.Data.OleDb.OleDbType.WChar, 30, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "TYPF_OMSCHRIJVING", Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As TypeFactDS.TypeFactDataTable, ByVal TYPF_ID As Integer) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(TYPF_ID,Integer)
        ...
        Public Overloads Overridable Function GetData(ByVal TYPF_ID As Integer) As TypeFactDS.TypeFactDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(TYPF_ID,Integer)
            Dim dataTable As TypeFactDS.TypeFactDataTable = New TypeFactDS.TypeFactDataTable()
        ...
        Public Overloads Overridable Function FillCBO(ByVal dataTable As TypeFactDS.TypeFactDataTable) As Integer
        ...
        Public Overloads Overridable Function GetDataCBO() As TypeFactDS.TypeFactDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Dim dataTable As TypeFactDS.TypeFactDataTable = New TypeFactDS.TypeFactDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As TypeFactDS.TypeFactDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As TypeFactDS) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_TYPF_OMSCHRIJVING As String, ByVal Original_TYPF_Conversion As Global.System.Nullable(Of Integer), ByVal Original_TYPF_ID As Integer, ByVal Original_TypF_actief As Boolean) As Integer
            If (Original_TYPF_OMSCHRIJVING Is Nothing) Then
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(1).Value = Global.System.DBNull.Value
            Else
                Me.Adapter.DeleteCommand.Parameters(0).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(1).Value = CType(Original_TYPF_OMSCHRIJVING,String)
            End If
            If (Original_TYPF_Conversion.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(3).Value = CType(Original_TYPF_Conversion.Value,Integer)
            Else
                Me.Adapter.DeleteCommand.Parameters(2).Value = CType(1,Object)
                Me.Adapter.DeleteCommand.Parameters(3).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.DeleteCommand.Parameters(4).Value = CType(Original_TYPF_ID,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal TYPF_OMSCHRIJVING As String, ByVal TYPF_Conversion As Global.System.Nullable(Of Integer), ByVal TypF_actief As Boolean, ByVal Original_TYPF_OMSCHRIJVING As String, ByVal Original_TYPF_Conversion As Global.System.Nullable(Of Integer), ByVal Original_TYPF_ID As Integer, ByVal Original_TypF_actief As Boolean) As Integer
            If (TYPF_OMSCHRIJVING Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(4).Value = CType(Original_TYPF_OMSCHRIJVING,String)
            End If
            If (Original_TYPF_Conversion.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_TYPF_Conversion.Value,Integer)
            Else
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(1,Object)
                Me.Adapter.UpdateCommand.Parameters(6).Value = Global.System.DBNull.Value
            End If
            Me.Adapter.UpdateCommand.Parameters(7).Value = CType(Original_TYPF_ID,Integer)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function typF_id(ByVal TYPF_OMSCHRIJVING As String) As Global.System.Nullable(Of Integer)
            Dim command As Global.System.Data.OleDb.OleDbCommand = Me.CommandCollection(2)
            If (TYPF_OMSCHRIJVING Is Nothing) Then
                command.Parameters(0).Value = Global.System.DBNull.Value
            Else
                command.Parameters(0).Value = CType(TYPF_OMSCHRIJVING,String)
            End If
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As TypeFactDS, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As TypeFactDS, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._typeFactTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As TypeFactDS, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._typeFactTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As TypeFactDS) As Integer
